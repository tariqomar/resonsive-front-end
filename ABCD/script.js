 ...
 */
 ...
 var dropdown = document.querySelector(".header-navbar .hamburger-btn");
 var button = document.querySelector(".header-navbar .header-hamburger");
 ...
 function menu() {
   if (dropdown.style.display === "grid") {
     ...
     button.innerHTML = "header-hamburger";
   } else {
 ...
 document.addEventListener("click", function(event) {
   var isClickInside = header-navbar.contains(event.target);
   if (!isClickInside) {
     if (dropdown.style.display === "grid") {
       dropdown.style.display = "none";
       button.innerHTML = "header-hamburger";
